...
{
    `
    This series of projects was undertaken in COMP 360A - Artificial Intelligence. We studied a combination of classical artificial intelligence and more modern concepts, all built around the framework of the Berkley Pacman Project. The creators of the project would prefer solutions to not be shared publicly, so they are not visible on public on my GitHub.
    The adjacent maze represents a portion of the search project. We were instructed to write search algorithms of various types: Depth First, Breadth First, Uniform Cost, and A*. This included exploring heuristics and a fair amount of problem solving. I spent much of my time considering different heuristics for A* to use. A heuristic is used to estimate the value of a state or action, and by comparing different values, the best action or future state can be chosen. For the scope of this pacman project, I found that simple heuristics were generally more effective.
    `
}
/>;
